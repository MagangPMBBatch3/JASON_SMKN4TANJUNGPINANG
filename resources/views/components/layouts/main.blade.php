...
@endif
    ...
    <button type="button"
            onclick="toggleMenu('subDataMenu','subArrow')"
            class="w-full flex items-center justify-between p-2 rounded hover:bg-blue-500">
        <div class="flex items-center">
            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"></path>
        ...
        <svg id="subArrow" xmlns="http://www.w3.org/2000/svg"
             class="h-4 w-4 transform transition-transform duration-200"
             fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                  d="M19 9l-7 7-7-7" />
    ...
    <ul id="subDataMenu" class="ml-4 mt-2 space-y-1 hidden">
        <li class="mb-2">
            <a href="{{ route('pesan') }}" class="block p-2 rounded hover:bg-blue-500 text-sm">Pesan</a>
        </li>
        <li class="mb-2">
            <a href="{{ route('aktivitas') }}" class="block p-2 rounded hover:bg-blue-500 text-sm">Aktivitas</a>
        </li>
        <li class="mb-2">
        ...
        <li class="mb-2">
         ...
         <a href="/lembur"
                   class="block py-2 hover:bg-blue-500 rounded px-2 {{ request()->is('lembur') ? 'bg-blue-500' : '' }}">
                    <div class="flex items-center">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2H5a2 2 0 00-2-2z"></path>
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 5a2 2 0 012-2h2a2 2 0 012 2v6H8V5z"></path>
