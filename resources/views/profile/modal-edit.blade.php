...
<div class="lg:col-span-1" id="modalEditProfile">
            ...
            <div class="bg-white p-6 rounded-xl shadow-md">
                ...
                method="POST" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <select name="level_id" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200">
                     ...
                     <div>
                        ...
                        <select name="status_id" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200">
                                <option value="">Pilih status</option>
                            @foreach($statuses as $status)
                                <option value="{{ $status->id }}" {{ $userProfile->status_id == $status->id ? 'selected' : '' }}>
                                {{ $status->nama }}
                                </option>
                            @endforeach
                        </select>
