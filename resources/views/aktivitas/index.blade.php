<x-layouts.main title="Data Aktivitas">
     <x-slot name="pageTitle">Daftar Aktivitas</x-slot>
    <div class="bg-white p-4 rounded shadow w-full">
        ...
        <div class="flex justify-between mb-4">
            ...
            <x-button color="blue" onclick="openAddAktivitasModal()">
                Tambah Data
            </x-button>
        </div>
    ...
    {{-- Table Aktif --}}
<x-table :headers="['ID', 'Bagian ID', 'No Wbs', 'Nama', 'Aksi']" tbodyId="dataAktivitas" id="tableAktif" />

{{-- Table Arsip --}}
<x-table :headers="['ID', 'Bagian ID', 'No Wbs', 'Nama', 'Aksi']" tbodyId="dataAktivitasArsip" id="tableArsip" class="hidden" />
